--
-- This script sets up the tables for achievements and messaging, which are key
-- features for user engagement. It also includes the necessary RLS policies
-- and inserts some default achievements to get the system started.
--
