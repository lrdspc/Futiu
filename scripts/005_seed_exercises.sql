--
-- This script seeds the `exercises` table with a set of default, public exercises.
-- These exercises are available to all users and can be used to create workouts.
--
