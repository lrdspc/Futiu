--
-- This script sets up the initial tables for users and their profiles,
-- along with the necessary row-level security (RLS) policies and a trigger
-- to handle new user creation from the Supabase `auth.users` table.
--
