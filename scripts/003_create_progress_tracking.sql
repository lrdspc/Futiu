--
-- This script creates the tables necessary for tracking user progress,
-- including workout sessions, exercise logs, body measurements, and progress photos.
-- RLS policies are also set up to ensure data privacy and appropriate access
-- for both students and personal trainers.
--
