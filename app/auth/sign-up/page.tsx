...
/**
 * The sign-up page for the application.
 *
 * This component displays a sign-up form that allows new users to create an account
 * as a student or a personal trainer. It handles the sign-up process with Supabase
