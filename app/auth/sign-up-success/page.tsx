...
/**
 * The sign-up success page.
 *
 * This component is displayed after a user successfully signs up for an account.
 * It informs the user to check their email for a confirmation link.
 *
 * @returns {JSX.Element} The sign-up success page component.
 */
