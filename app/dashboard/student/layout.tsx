...
/**
 * The layout for the student dashboard.
 *
 * This component provides the sidebar navigation and main content area for the student
 * dashboard. It also handles authentication, ensuring that only authenticated students
