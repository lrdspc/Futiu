...
/**
 * The main dashboard page for the student.
 *
 * This component displays a summary of the student's progress, including weekly
 * progress, workout streak, today's workout, upcoming workouts, and recent
 * achievements.
 *
