...
/**
 * The layout for the personal trainer dashboard.
 *
 * This component provides the sidebar navigation and main content area for the personal
 * trainer dashboard. It also handles authentication, ensuring that only authenticated
 * personal trainers can access the dashboard.
 *
 * @param {{ children: React.ReactNode }} props - The props for the component.
 * @returns {JSX.Element} The personal trainer dashboard layout.
 */
