...
/**
 * The main dashboard page for the personal trainer.
 *
 * This component displays a summary of the personal trainer's activity, including
 * key statistics, upcoming evaluations, recent student activity, and quick
 * action buttons.
 *
 * @returns {JSX.Element} The personal trainer dashboard page.
 */
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <WorkoutRealtimeAdjust workoutId="1" studentId="1" />
      </div>
